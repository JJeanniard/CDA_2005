...
namespace Tp_Freelance.Controllers
{
    public class CustomerCatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CatName,CatDescription")] CustomerCat customerCat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CatName,CatDescription")] CustomerCat customerCat)
        {
